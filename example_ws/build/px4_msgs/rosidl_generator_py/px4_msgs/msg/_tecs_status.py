...
class TecsStatus(metaclass=Metaclass_TecsStatus):
    ...
    def __init__(self, **kwargs):
        ...
        self.altitude_sp_filtered = kwargs.get('altitude_sp_filtered', float())
    ...
    def __eq__(self, other):
        ...
        if self.altitude_sp != other.altitude_sp:
            return False
        if self.altitude_sp_filtered != other.altitude_sp_filtered:
            return False
    ...
    @builtins.property
    def altitude_sp_filtered(self):
        """Message field 'altitude_sp_filtered'."""
        return self._altitude_sp_filtered

    @altitude_sp_filtered.setter
    def altitude_sp_filtered(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'altitude_sp_filtered' field must be of type 'float'"
            assert value >= -3.402823e+38 and value <= 3.402823e+38, \
                "The 'altitude_sp_filtered' field must be a float in [-3.402823e+38, 3.402823e+38]"
        self._altitude_sp_filtered = value
