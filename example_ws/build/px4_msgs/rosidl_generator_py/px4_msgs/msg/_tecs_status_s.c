...
bool px4_msgs__msg__tecs_status__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  ...
  {  // altitude_sp_filtered
    PyObject * field = PyObject_GetAttrString(_pymsg, "altitude_sp_filtered");
    if (!field) {
      return false;
    }
    assert(PyFloat_Check(field));
    ros_message->altitude_sp_filtered = (float)PyFloat_AS_DOUBLE(field);
    Py_DECREF(field);
  }
...
PyObject * px4_msgs__msg__tecs_status__convert_to_py(void * raw_ros_message)
{
  ...
  {  // altitude_sp_filtered
    PyObject * field = NULL;
    field = PyFloat_FromDouble(ros_message->altitude_sp_filtered);
    {
      int rc = PyObject_SetAttrString(_pymessage, "altitude_sp_filtered", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
