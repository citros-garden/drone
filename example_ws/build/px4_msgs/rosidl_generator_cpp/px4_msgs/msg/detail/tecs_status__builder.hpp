...
class Init_TecsStatus_altitude_sp_filtered
{
public:
  explicit Init_TecsStatus_altitude_sp_filtered(::px4_msgs::msg::TecsStatus & msg)
  : msg_(msg)
  {}
  Init_TecsStatus_height_rate_setpoint altitude_sp_filtered(::px4_msgs::msg::TecsStatus::_altitude_sp_filtered_type arg)
  {
    msg_.altitude_sp_filtered = std::move(arg);
...
public:
  ...
  : msg_(msg)
  {}
  Init_TecsStatus_altitude_sp_filtered altitude_sp(::px4_msgs::msg::TecsStatus::_altitude_sp_type arg)
  {
    msg_.altitude_sp = std::move(arg);
    return Init_TecsStatus_altitude_sp_filtered(msg_);
  }
