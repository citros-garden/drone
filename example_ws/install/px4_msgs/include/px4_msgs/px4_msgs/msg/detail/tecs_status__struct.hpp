...
struct TecsStatus_
{
  ...
  explicit TecsStatus_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  {
      ...
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      ...
      this->altitude_sp_filtered = 0.0f;
  ...
  using _altitude_sp_filtered_type =
    float;
  _altitude_sp_filtered_type altitude_sp_filtered;
  ...
  Type & set__altitude_sp_filtered(
    const float & _arg)
  {
    this->altitude_sp_filtered = _arg;
    return *this;
  }
  ...
  bool operator==(const TecsStatus_ & other) const
  {
    ...
    if (this->altitude_sp_filtered != other.altitude_sp_filtered) {
      return false;
    }
